...
radar_2_pos_3d = [radar_separation,0,radar_height];
...
figure('Name','Blind areas of Radars for Gait Trials - Experiment A','NumberTitle','off')
hold on
...
title('Blind Areas for Gait Trials - Experiment A')
subtitle(['\theta = ' num2str(round(theta,2)) '^{\circ} and \phi = ' num2str(round(phi,2)) '^{\circ}'])

% Visualise radars and their field-of-view
plot_RadarFOV_ExpA(radar_1_pos_3d,radar_2_pos_3d,theta,phi,max_range,beam_angle,z_limits)
zlim([0 z_limits(2)])
...
figure('Name','Top and Side view of Blind areas of Radars for Gait Trials - Experiment A','NumberTitle','off')
...
sgtitle('Blind Areas for Gait Trials - Experiment A')